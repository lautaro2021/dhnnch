...
function Cards() {
    return (
        <section className="l:bg-custom-gradient bg-white flex items-end py-[100px] w-full t:flex-col t:items-start t:justify-start t:overflow-hidden t:py-[60px]">
            <Modal bgColor="bg-secondaryWhite md:!bg-white" size="s">
                <>
