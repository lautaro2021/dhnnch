...
function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full h-[89px] flex items-center justify-center px-120 border-b-[1px] border-grey bg-white z-[100] md:px-[16px] sm:h-[61px]">
